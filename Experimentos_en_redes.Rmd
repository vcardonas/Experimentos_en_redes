...
# Rename the columns
colnames(df) <- c("Individuo", "Zi = 0", "Zi = 1", "Zi = 0", "Zi = 1")

# Create the table
kable(df, caption = "Resultados Potenciales") %>%
...
Entonces, en la primera matriz simétrica $N \times N$, podemos recuperar para una condición de exposición fija $c_k$, tanto la probabilidad de exposición individual $p_{i}^{e}(c_k)$ como las probabilidades de exposición conjunta $p_{ij}^{e}(c_k)$, para todos los individuos $i, j = 1,\ldots,N$:
\begin{equation}
